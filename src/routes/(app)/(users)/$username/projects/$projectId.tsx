      ...
      <article className="flex-1 overflow-y-auto">
          ...
          <div className="absolute right-0 bottom-0 left-0 flex items-center justify-between gap-4 p-4">
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-1">
                <HiMiniHeart />
                <span className="text-xs">3k Likes</span>
              </div>
              <div className="flex items-center gap-1">
                <HiMiniUserGroup />
                <span className="text-xs">5 Contributors</span>
              </div>
            </div>
            <div className="flex items-center gap-1">
              <HiMiniEye />
              <span className="text-xs">7k Views</span>
            </div>
          </div>
        </div>
        ...
        <section className="flex items-center justify-between gap-4 p-4">
          <div className="space-y-1">
            <h2 className="text-lg/tight font-bold">Sprite Joke in a bottle</h2>
